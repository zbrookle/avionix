...
The real power of avionix comes from it being object oriented and written in a
programming language as opposed to the limited logic that comes with yaml. One aspect
of popular programming that is missing from helm_, that avionix has is inheritance.
This is an excerpt from another package built with avionix, avionix_airflow_
