...
from helm_factory.kubernetes_objects.reference import OwnerReference
...
class ManagedFieldsEntry(HelmYaml):
    """
    :param fields_type: FieldsType is the discriminator for the different fields \
        format and version. There is currently only one possible value: "FieldsV1"
    ...
    :param api_version: APIVersion defines the version of this resource that this \
        field set applies to. The format is "group/version" just like the top-level \
...
class ObjectMeta(HelmYaml):
    ...
    :param owner_references: List of objects depended by this object. If ALL objects \
        in the list have been deleted, this object will be garbage collected. If this \
