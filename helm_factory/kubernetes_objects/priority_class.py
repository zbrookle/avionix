...
class PriorityClass(KubernetesBaseObject):
    ...
    :param global_default: globalDefault specifies whether this PriorityClass should \
        be considered as the default priority for pods that do not have any priority \
